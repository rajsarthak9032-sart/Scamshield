...
- Do not speculate about why the user submitted the message.
- Do not describe the message as a test, example, simulation, or demonstration unless the submitted message explicitly says that.
- Base conclusions only on evidence contained in the submitted message and the deterministic findings provided by ScamShield.
- Do not invent context, sender identity, intent, consequences, or facts that are not supported by the input.
- Do not claim that a message is definitely fraudulent or definitely safe.
"""
